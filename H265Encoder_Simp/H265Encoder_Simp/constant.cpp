...
int16_t g_lumaFilter[4][NTAPS_LUMA] =
{
	{ 0, 0, 0, 64, 0, 0, 0, 0 },
	{ -1, 4, -10, 58, 17, -5, 1, 0 },
	{ -1, 4, -11, 40, 40, -11, 4, -1 },
...
int16_t g_chromaFilter[8][NTAPS_CHROMA] =
{
	{ 0, 64, 0, 0 },
	{ -2, 58, 10, -2 },
	{ -4, 54, 16, -2 },
...
uint16_t g_scan2x2[][2 * 2] =
{
	{ 0, 2, 1, 3 },
	{ 0, 1, 2, 3 },
};

uint16_t g_scan8x8[NUM_SCAN_TYPE][8 * 8] =
{
...
uint16_t g_scan4x4[NUM_SCAN_TYPE][4 * 4] =
{
...
uint16_t*  g_scanOrder[NUM_SCAN_TYPE][NUM_SCAN_SIZE] =
{
...
uint16_t*  g_scanOrderCG[NUM_SCAN_TYPE][NUM_SCAN_SIZE] =
{
