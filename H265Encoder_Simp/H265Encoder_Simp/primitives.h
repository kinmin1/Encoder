...
typedef int(*pixelcmp_t2)(const pixel* fenc, int fencstride, const pixel* fref, int frefstride, int lx, int ly);
typedef int(*pixelcmp_t1)(const pixel* fenc, int fencstride, const pixel* fref, int frefstride, int w, int h);
typedef int(*pixelcmp_t5)(const pixel* fenc, intptr_t fencstride, const pixel* fref, intptr_t frefstride, int size); // fenc is aligned
typedef int(*pixelcmp_t)(const pixel* fenc, intptr_t fencstride, const pixel* fref, intptr_t frefstride, int w, int h); // fenc is aligned
typedef int(*pixelcmp_ss_t)(const int16_t* fenc, intptr_t fencstride, const int16_t* fref, intptr_t frefstride, int size);
typedef int(*pixelcmp_ss_t1)(const int16_t* fenc, int fencstride, const int16_t* fref, int frefstride, int lx, int ly);
typedef int(*pixel_ssd_s_t)(const int16_t* fenc, intptr_t fencstride, int size);
typedef void(*pixelcmp_x4_t)(const pixel* fenc, const pixel* fref0, const pixel* fref1, const pixel* fref2, const pixel* fref3, intptr_t frefstride, int* res, int lx, int ly);
typedef void(*pixelcmp_x3_t)(const pixel* fenc, const pixel* fref0, const pixel* fref1, const pixel* fref2, intptr_t frefstride, int* res, int lx, int ly);
typedef void(*blockfill_s_t)(int16_t* dst, intptr_t dstride, int16_t val, int size);

typedef void(*intra_pred_t)(pixel* dst, intptr_t dstStride, const pixel *srcPix, int dirMode, int bFilter, int width);//¸´ÔÓÉùÃ÷
typedef void(*intra_allangs_t)(pixel *dst, pixel *refPix, pixel *filtPix, int bLuma, int log2Size);
typedef void(*intra_filter_t)(const pixel* references, pixel* filtered, int tuSize);

typedef void(*cpy2Dto1D_shl_t)(int16_t* dst, int16_t* src, intptr_t srcStride, int shift, int size);
typedef void(*cpy2Dto1D_shr_t)(int16_t* dst, int16_t* src, intptr_t srcStride, int shift, int size);
typedef void(*cpy1Dto2D_shl_t)(int16_t* dst, int16_t* src, intptr_t dstStride, int shift, int size);
typedef void(*cpy1Dto2D_shr_t)(int16_t* dst, int16_t* src, intptr_t dstStride, int shift, int size);
typedef uint32_t(*copy_cnt_t)(int16_t* coeff, int16_t* residual, intptr_t resiStride, int size);

typedef void(*dct_t)(int16_t* src, int16_t* dst, intptr_t srcStride);
typedef void(*idct_t)(int16_t* src, int16_t* dst, intptr_t dstStride);
typedef void(*denoiseDct_t)(int16_t* dctCoef, unsigned int* resSum, const uint16_t* offset, int numCoeff);

typedef void(*calcresidual_t)(const pixel* fenc, const pixel* pred, int16_t* residual, intptr_t stride, int blockSize);
typedef void(*transpose_t)(pixel* dst, const pixel* src, intptr_t stride, int blockSize);
typedef unsigned int(*quant_t)(const int16_t* coef, const int* quantCoeff, int* deltaU, int16_t* qCoef, int qBits, int add, int numCoeff);
typedef unsigned int(*nquant_t)(const int16_t* coef, const int* quantCoeff, int16_t* qCoef, int qBits, int add, int numCoeff);
typedef void(*dequant_scaling_t)(const int16_t* src, const int* dequantCoef, int16_t* dst, int num, int mcqp_miper, int shift);
typedef void(*dequant_normal_t)(const int16_t* quantCoef, int16_t* coef, int num, int scale, int shift);
typedef int(*count_nonzero_t)(uint32_t trSize, const int16_t* quantCoeff);
...
typedef unsigned long long(*var_t)(const pixel* pix, intptr_t stride, int size);
...
typedef void(*filter_pp_t) (const pixel* src, intptr_t srcStride, pixel* dst, intptr_t dstStride, int coeffIdx, int bx, int by, int N);
typedef void(*filter_hps_t) (const pixel* src, intptr_t srcStride, int16_t* dst, intptr_t dstStride, int coeffIdx, int isRowExt, int bx, int by, int N);
typedef void(*filter_ps_t) (const pixel* src, intptr_t srcStride, int16_t* dst, intptr_t dstStride, int coeffIdx, int bx, int by, int N);
typedef void(*filter_sp_t) (const int16_t* src, intptr_t srcStride, pixel* dst, intptr_t dstStride, int coeffIdx, int bx, int by, int N);
typedef void(*filter_ss_t) (const int16_t* src, intptr_t srcStride, int16_t* dst, intptr_t dstStride, int coeffIdx, int bx, int by, int N);
typedef void(*filter_hv_pp_t) (const pixel* src, intptr_t srcStride, pixel* dst, intptr_t dstStride, int idxX, int idxY, int bx, int by, int N);
typedef void(*filter_p2s_t)(const pixel* src, intptr_t srcStride, int16_t* dst, intptr_t dstStride, int bx, int by);

typedef void(*copy_pp_t)(pixel* dst, intptr_t dstStride, pixel* src, intptr_t srcStride, int bx, int by); // dst is aligned
typedef void(*copy_sp_t)(pixel* dst, intptr_t dstStride, const int16_t* src, intptr_t srcStride, int bx, int by);
typedef void(*copy_ps_t)(int16_t* dst, intptr_t dstStride, const pixel* src, intptr_t srcStride, int bx, int by);
typedef void(*copy_ss_t)(int16_t* dst, intptr_t dstStride, const int16_t* src, intptr_t srcStride, int bx, int by);

typedef void(*pixel_sub_ps_t)(int16_t* dst, intptr_t dstride, const pixel* src0, const pixel* src1, intptr_t sstride0, intptr_t sstride1, int bx, int by);
typedef void(*pixel_add_ps_t)(pixel* a, intptr_t dstride, const pixel* b0, const int16_t* b1, intptr_t sstride0, intptr_t sstride1, int bx, int by);
typedef void(*pixelavg_pp_t)(pixel* dst, intptr_t dstride, const pixel* src0, intptr_t sstride0, const pixel* src1, intptr_t sstride1, int weight, int lx, int ly);
typedef void(*addAvg_t)(const int16_t* src0, const int16_t* src1, pixel* dst, intptr_t src0Stride, intptr_t src1Stride, intptr_t dstStride, int bx, int by);
...
typedef unsigned int(*findPosFirstLast_t)(const int16_t *dstCoeff, const int8_t trSize, const uint16_t scanTbl[16]);

/* Function pointers to optimized encoder primitives. Each pointer can reference
* either an assembly routine, a SIMD intrinsic primitive, or a C function */
typedef struct EncoderPrimitives
{
	int a;
	...
	* primitives will leave 64x64 pointers NULL.  Indexed by LumaCU */
	struct CU
	{
		...
		pixelcmp_t1      sse_pp;        // Sum of Square Error (pixel, pixel) fenc alignment not assumed
		pixelcmp_ss_t1   sse_ss;        // Sum of Square Error (int16_t, int16_t) fenc alignment not assumed
		pixelcmp_t5      psy_cost_pp;   // difference in AC energy between two pixel blocks
...
int partitionFromLog2Size(int log2Size);
void setupCPrimitives(EncoderPrimitives *p);
void setupAliasPrimitives(EncoderPrimitives *p);
void x265_setup_primitives();
